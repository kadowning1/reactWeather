    ...
    <div className="">
      <form className='flex flex-col justify-center items-center'>
        ...
        <div className="relative justify-center w-1/2">
          ...
          <button type="submit" className="cursor-pointer text-white absolute right-2.5 bottom-2.5 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2" onClick={addLocation} disabled={disableSearch}>Search</button>
        </div>
      </form>
    </div>
  );
